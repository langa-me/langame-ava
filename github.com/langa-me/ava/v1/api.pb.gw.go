...
func RegisterConversationStarterServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConversationStarterServiceServer) error {
	...
	mux.Handle("POST", pattern_ConversationStarterService_GetConversationStarter_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ava.ConversationStarterService/GetConversationStarter", runtime.WithHTTPPathPattern("/v1/api/conversation/starter"))
		if err != nil {
...
func RegisterConversationStarterServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn grpc.ClientConnInterface) error {
...
func RegisterConversationStarterServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConversationStarterServiceClient) error {
	...
	mux.Handle("POST", pattern_ConversationStarterService_GetConversationStarter_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ava.ConversationStarterService/GetConversationStarter", runtime.WithHTTPPathPattern("/v1/api/conversation/starter"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
